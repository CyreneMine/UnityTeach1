...
- Begin 场景收尾：开始游戏、退出游戏、设置面板、排行榜面板、音乐设置、排行榜数据保存等基础菜单功能已经串起来；并补充了独立 UI 摄像机渲染方案，下一步从游戏场景核心玩法开始。
...
- 本项目已进入实践小项目制作阶段，目前完成到 P80，Begin 场景基础功能基本完成。
